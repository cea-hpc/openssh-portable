...
+almalinux-image+ directory. All scripts started in the containers are located in
the +almalinux-image+ directory.
...
The tests that run on tester can be found in the +almalinux-image/test.sh+ file.
